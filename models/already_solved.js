...
module.exports = class Already_solved extends Sequelize.Model {
  ...
  static init(sequelize) {
    return super.init(
      ...
      },
      {
        ...
        modelName: "Already_solved", //모델 이름을 설정할 수있다
        tableName: "Already_solved", //기본적으로 모델이름을 소문자및 복수형으로 만드는데 모델이 User면 users가된다
